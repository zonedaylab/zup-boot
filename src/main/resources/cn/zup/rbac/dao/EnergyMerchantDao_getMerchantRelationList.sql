  ...
  <#if energyMerchant.checkStateConfig?exists>
	and checkStateConfig.configid=${energyMerchant.checkStateConfig}
	 ...
	 left join ENERGY_RELATION r on r.common_organ_id=t.organid
 where 1=1 
 <#if energyMerchant.parentOrganFlag?exists>
 	and r.department_id= ${energyMerchant.parentOrganFlag}
 </#if>
  <#if energyMerchant.organFlag?exists>
 	and t.organid= ${energyMerchant.organFlag}
 </#if>
