 select e.organid,e.region_Code,e.merchant_Name,e.merchant_Code,e.merchant_Type,e.check_State,e.reg_Number,e.reg_Capital,e.legal_Person,
  	...
  	e.address,e.latitude,e.longitude,e.merchant_Scale,e.energy_Property,e.reg_User_Id,e.reg_User_Name,e.reg_Date,
  ...
  left join
               energy_relation r 
                    on r.common_organ_id =e.organid 
  
		where 1=1
		<#if organId?exists>
	 		and r.common_organ_id=${organId}
	 	</#if>
