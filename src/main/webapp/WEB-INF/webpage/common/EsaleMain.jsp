...
<html lang="en">
	...
	<body style="overflow-x:hidden;">
		<div id="head">
			<img src="plug-in/login/esale/images/logo.png" width="394" height="60" alt="LOGO"/>
		</div>
		<div id="content">
					...
					<form>
						<ul class="login-info">
							...
							<div class="login-other">
								...
								<div>
									<a href="rest/rbac/ResaleMerchantRegisterController" class="underline" style="text-decoration:none;margin-left:140px;">注册</a>
								</div>
							</div>
		...
		<div id="foot">
			<p class="foot-info"><span><a href="esaleSystemInfoController/pcFeekback" id="esaleVersion"></a><a href="javascript:void(0);" id="links">联系我们</a></span></p>
		</div>
		<!--linkNumber	-->
