	...
	<body>
		<div class="reg-box">
			<div class="reg-hender">
				<img id="imgSc" src="plug-in/login/esale/gdmy/sign-logo.png" />
				<p class="reg-login">
					<a href="System/signOut?url=esale/GdMyrhEsaleLogin">返回登录</a>
				</p>
			</div>
			<!--第一步-->
				...
				<div class="reg-form" style="background-color: #fff;">
					<div class="reg-form-text" style="text-align: center; margin: 80px 0;">
						...
						<p class="reg-tips" style="color:#ec1042">为了保障您的信息安全请登录后重置密码！</p>
						 <a class="reg-btn" href="System/signOut?url=esale/GdMyrhEsaleLogin" >立即登录</a>
					</div>
				</div>
			</div>
