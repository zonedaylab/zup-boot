...
<base href="<%=basePath%>">
    ...
    <link href="plug-in/ace/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="plug-in/ueditor/site.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="container" style="padding-top: 5px; padding-left: 5px">
    <form method="post" id="saveform" name="saveform" action="">
        ...
        <div class="row">
            <div class="span2">
                <ul class="nav nav-list row">
<!--                    <li class="nav-header rowjj">表单控件</li>-->
                    <li> <a class="col-md-2 col-lg-2 col-xs-5 jj" style="color:#000000; font-size:16px;">表单控件：</a></li>
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('forms');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">form表单</a></li>
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('text');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">文本框</a></li>
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('textarea');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">多行文本</a></li>
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('select');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">下拉菜单</a></li>
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('radios');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">单选框</a></li>
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('checkboxs');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">复选框</a></li>
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('dates');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">日期框</a></li>
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('upload');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">文件上传</a></li>
                    <!-- 
            ...
            <div class="span10">
                <script id="formEditor" type="text/plain" style="width:100%; margin-top:10px;">${form.originalHtml}</script>
            </div>
        </div><!--end row-->
        <div class="row" style="margin-top:10px;">
			<a href="javascript:void(0);" onclick="formDesign.fnCheckForm('save');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj" style="float:right;">提交</a>
        </div>
    </form>
</div><!--end container-->
<script type="text/javascript" charset="utf-8" src="plug-in/ace/assets/js/jquery-2.0.3.min.js"></script>
...
<script type="text/javascript" charset="utf-8" src="plug-in/ueditor/formdesign/formdesign.v4.js"></script>
<!-- script start-->
...
var formEditor = UE.getEditor('formEditor',{
    ...
    ,iframeCssUrl:"plug-in/ace/assets/cs s/bootstrap.min.css" //引入自身 css使编辑器兼容你网站css
...
var formDesign = {
    ...
    fnCheckForm : function ( type ) {
        ...
        if(formEditor.hasContents()){
            ...
            $.ajax({
                type: 'POST',
                url : '${ctx}/rest/formdesign/designer/save',
    ...
    fnReview : function (){
        ...
        if(formEditor.hasContents()){
            formEditor.sync();       /*同步内容*/
            alert($("#formEditor").val());
            /*设计form的target 然后提交至一个新的窗口进行预览*/
            document.saveform.target="mywin";
            window.open('','mywin',"menubar=0,toolbar=0,status=0,resizable=1,left=0,top=0,scrollbars=1,width=" +(screen.availWidth-10) + ",height=" + (screen.availHeight-50) + "\"");
            document.saveform.action="temp_preview.html";
