...
<body style="background-color:#FFFFFF; overflow-x : hidden ;">
		...
		<div class="col-sm-9 col-xs-12 col-lg-9 widget-body">
						...
						<div class="col-md-12 column">
							<form class="form-horizontal" role="form">
								<div class="form-group">
									<label class="col-xs-5 col-md-2 control-label" style="text-align: right" for="postNameQuery">岗位名称：</label>
									<div class="col-xs-4 col-md-3"> 
										<select class="form-control" id="postNameQuery">
											<option value="">&nbsp;</option>									
										</select>
									</div>							
									<label class="col-xs-5 col-md-2 control-label" id="POSITIONDEPRESS" style="text-align: right" for="realname">真实姓名：</label>
									<div class="col-xs-4 col-md-3">
										<input type="text" id="realNameQuery"  class="form-control"/><!-- form-field-1 -->
									</div>
									<div class="col-md-2 col-xs-2" style=" position:absolute; right:20px; top:0px">
			...
			<div class="row">
				<div class="col-md-12" style="margin-left:20px;height:30px; margin-bottom:10px; margin-top:5px;">
					...
					<button class="btn btn-primary btn-sm" id="btnManage">账户管理</button>
				</div>
		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form">
						<div class="form-group">
							 <strong for="organName" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;"  >组织机构：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3">
								<input class="form-control" id="organName"  readonly="readonly" type="text" />
							</div>
							 <strong for="createDate" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >登记日期：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3">
								<input class="form-control date-picker" id="createDate" type="text" />
							</div>
						...
						<div class="form-group">
							 <strong for="userAddPostName" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >岗&nbsp;&nbsp;位：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3"> 
					            <select id="userAddPostName" class="form-control" >
						              <option value="">&nbsp;</option> 
					            </select>
							</div>
							<div class="col-xs-1 col-md-1" id="firststar" style="position:absolute; top:56px; left:320px">
								<font color=red>*</font>
							</div>
							 <strong for="realNameAdd" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >真实姓名：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3">
								<input class="form-control" id="realNameAdd" type="text" />
							</div>
							<div class="col-xs-1 col-md-1" id="firststar" style="position:absolute; top:56px; right:83px">
								<font color=red>*</font>
							</div>
						</div> 
		       			
						<div class="form-group">
							 <strong for="birthday" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >出生年月：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3">
								<input class="date-picker form-control" id="birthday" type="text"   data-date-format="yyyy-mm-dd" />
							</div>
							<strong for="identitycard" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >身份证号：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3">
								<input class="form-control" id="identitycard" type="text" />
							</div>
							<div class="col-xs-1 col-md-1" id="secondstar" style="position:absolute; top:104px; right:83px" >
								<font color=red></font>
							</div>
						</div>
						...
						<div class="form-group">
							 <strong for="phone" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >联系电话：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3">
								<input class="form-control" id="cellphone" type="text" />
							</div>
							 <strong for="cellphone" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:10px;" >手机号：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3">
            			...
            			<div class="form-group">
							...
							<strong for="politicsStatus" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >政治面貌：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3"> 
					            <select id="politicsStatus" class="form-control" >
						              <option value="">&nbsp;</option> 
					            </select>
							</div>
							<div class="col-xs-1 col-md-1">
						...
						<div class="form-group">
							 <strong for="contractType" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >合同类型：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3"> 
					            <select id="contractType" class="form-control" >
						              <option value="">&nbsp;</option> 
					            </select>
							</div>
							<strong for="contractStartDate" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right" >合同起始日期：</strong>
								<div class="col-xs-3 col-md-3 col-sd-3">
									<input class="form-control date-picker" id="contractStartDate" type="text" />
								</div>
								<div class="col-xs-1 col-md-1">
						...
						<div class="form-group">
							 <strong for="contractTerminationDate" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right" >合同终止日期：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3"> 
					          <input class="form-control date-picker" id="contractTerminationDate" type="text" />
							</div>
							 <strong for="graduationDate" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:5px;" >毕业日期：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3">
								<input class="form-control date-picker" id="graduationDate" type="text" />
							</div>
							<div class="col-xs-1 col-md-1">
            			...
            			<div class="form-group">
							 <strong for="validFlag" class="col-xs-2 col-md-2 col-sd-2 control-label" style="text-align:right;letter-spacing:10px;" >有效性：</strong>
							<div class="col-xs-3 col-md-3 col-sd-3"> 
							...
							<strong for="education" class="col-xs-2 col-md-2 control-label" style="text-align:right;letter-spacing:5px;" >学&nbsp;&nbsp;历：</strong>
                  		...
                  		<div class="form-group">
							 <strong for="address" class="col-xs-2 col-md-2 control-label" style="text-align:right;letter-spacing:5px;" >家庭住址：</strong>
							<div class="col-xs-3 col-md-3">
								<input class="form-control" id="address" type="text" />
							</div>
							 <strong for="professionalInfo" class="col-xs-2 col-md-2 control-label" style="text-align:right" >专业技术信息：</strong>
							<div class="col-xs-3 col-md-3">
								<input class="form-control" id="professionalInfo" type="text" />
							</div>
							<div class="col-xs-1 col-md-1">
	...
	<jsp:include page="../include/mainFooter.jsp"></jsp:include>   
      ...
      //日期控件
		...
		function findSelectData(){
	        ...
	        $.ajax({
	            type: "POST",
	            url: "rest/rbac/userController/getSex", 
	            cache: false,  //禁用缓存
	            dataType: "json",
	            success: function (result) {
	       			$("#sex").html(""); 	       			
	         ...
	         $.ajax({
	            type: "POST",
	            url: "rest/rbac/postController/loadPost",
	        ...
	        //获取政治面貌
             $.ajax({
	            type: "POST",
	            url: "rest/rbac/userController/getPoliticsStatus", 
	            cache: false,  //禁用缓存
	            dataType: "json",
	            success: function (result) {
        	...
        	//获取合同类型 
        	 $.ajax({
	            type: "POST",
	            url: "rest/rbac/userController/getContractType", 
	            cache: false,  //禁用缓存
	            dataType: "json",
	            success: function (result) {
        	...
        	//获取学历的下拉列表
        	 $.ajax({
	            type: "POST",
	            url: "rest/rbac/userController/getEducation", 
	            cache: false,  //禁用缓存
	            dataType: "json",
	            success: function (result) {
	       	            ...
	       	            success: function (response) {
	       	            	...
	       	            	if(response.data.length > 0){
		       	            	if(response.data[0].id == 0){  //确保是第一次加载根节点
		       	            		...
		       	            		response.data[0].name = "123"+"${usersession.organName}"
		       	            	}
		       	                callback(response);
	       	            	}else{
	       	            		callback(response);
	    ...
	    function loadTableData(){
        	...
        	var table = $("#usertable").dataTable({
	            ...
	            ajax: function (data, callback, settings) {	
	                ...
	                $.ajax({
	                    type: "POST",
	                    url: "rest/rbac/userController/getGridByOrgans",
	                    cache: false,  //禁用缓存
	                    data: param,  //传入组装的参数
	                    dataType: "json",
	                    success: function (result) {
            	...
            	columnDefs: [
                    ...
                    },
                    {
					    "sWidth":"11%",
					   	...
					   	"data": "birthdayString" // 数据列名
                    },
                    {
					    "sWidth":"9%",
					   	"targets": [9], // 目标列位置，下标从0开始
					   	"data": "educationString" // 数据列名
                    },
                    {
					    "sWidth":"16%",
					   	"targets": [10], // 目标列位置，下标从0开始
					   	"data": "professionalInfo" // 数据列名
                    }
            ]
        }).api();
	...
	function findselectorganData(postId){
        ...
        $.ajax({
            type: "POST",
            url: "rest/rbac/userController/loadPost",
            data: 'organId='+param.organId,          
            cache: false,  //禁用缓存
            dataType: "json",
            success: function (result) {        
	...
	function msginput(e, postIds){
		...
		e.preventDefault();
			var dialog = $( "#dialog-message" ).removeClass('hide').dialog({
				modal: true,
				title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='icon-ok'></i> 用户管理</h4></div>",
				title_html: true,
				width:840,
				height:560,
				buttons: [ 
					...
					},
					{
						...
						click: function() {
							if(thisid == "btnAdd"){ 
    								...
    								par.education = $("#education").val();   
    								if($("#birthday").val()!=null && $("#birthday").val() !="")
       								{
       								      par.birthday = new Date($("#birthday").val());
     								    //alert($("#birthday").val());
     								    //alert(par.birthday);  
       								}
    								if($("#graduationDate").val()!=null && $("#graduationDate").val() !="")
       								{
     								    par.graduationDate = new Date($("#graduationDate").val());  
       								}
    								if($("#contractStartDate").val()!=null && $("#contractStartDate").val() !="")
       								{
     								    par.contractStartDate = new Date($("#contractStartDate").val());  
       								}
    								if($("#contractTerminationDate").val()!=null && $("#contractTerminationDate").val() !="")
       								{
     								    par.contractTerminationDate = new Date($("#contractTerminationDate").val());  
       								}
    								if($("#createDate").val()!=null && $("#createDate").val() !="")
       								{
     								    par.createDate = new Date($("#createDate").val());  
       								}
    								par.politicsStatus = $("#politicsStatus").val();   
    								par.contractType = $("#contractType").val();       
    								par.professionalInfo = $("#professionalInfo").val();    
	...
	function add(par){			
		if(par.organId == null || par.organId == ""){
			...
			return;
				...
				parent.bootbox.alert("用户真实姓名不能为空", function(){});
				}
		else{  // if(IdentityCodeValid(par.identitycard))
				
			$.ajax({
   	            url: 'rest/rbac/userController/addUser',
   	            data: par,
   	            type: 'POST',
   	            dataType: 'json',
   	            success: function (result) {
	...
	function editAction(e){		
		...
		if(par.userId == null || par.userId == ""){
			...
			$.ajax({
	            url: 'rest/rbac/userController/getUserInfo',
	            ...
	            success: function (result) {
                	...
                	//alert("获取用户的岗位名称"+$("#userAddPostName").val());
	               // $("#userAddPostName").val(result.data[0].postId); 
	...
	function edit(par){
		if(par.organId == null || par.organId == ""){
			...
			return;
				...
				parent.bootbox.alert("岗位名称不能为空" , function(){});
				return;
		}else if(par.realName==null||par.realName==""){
			parent.bootbox.alert("用户名称不能为空", function(){});
			}
			else{
				par.userId = $("#userId:checked").val();
				par.organId = param.organId;
				...
				$.ajax({
		            url: 'rest/rbac/userController/editUserInfo',
		            data: par,
		            type: 'POST',
		            dataType: 'json',
		            success: function (result) {
		 ...
		 par.userIds=[];	     
			...
			if(result){				
				for(var i=0; i<$("#userId:checked").length;i++){
					...
					$.ajax({
	    	            url: 'rest/rbac/userController/delUserInfo',
	    	            async: false,
	    	            data: par,
	    	            type: 'POST',
	    	            dataType: 'json',
    ...
    function loadAccountTableData(){
    	...
    	var table = $("#accountTable").dataTable({
            ...
            ajax: function (data, callback, settings) { 
                ...
                $.ajax({
                    type: "POST",
                    url: "rest/rbac/userController/gridAccount",
                    cache: false,  //禁用缓存
                    data: param,  //传入组装的参数
                    dataType: "json",
                    success: function (result) {
  ...
  //账号管理
	...
	function accountAdd(accountpar){
		...
		if(accountpar.accountName==null||accountpar.accountName==""){
			...
			$.ajax({
  	            url: 'rest/rbac/userController/addAccount',
  	            data: accountpar,
  	            type: 'POST',
  	            dataType: 'json',
  	            success: function (result) {
	...
	function editAccountAction(e){
		accountpar.accountId = $("#accountId:checked").val();
	     if(accountpar.accountId == null || accountpar.accountId == ""){
			...
			$.ajax({
	            url: 'rest/rbac/userController/getAccountInfo',
	...
	function accountEdit(accountpar){
		...
		if(accountpar.accountName==null||accountpar.accountName==""){
			...
			$.ajax({
	            url: 'rest/rbac/userController/editAccountInfo',
	            data: accountpar,
	            type: 'POST',
	            dataType: 'json',
	            success: function (result) {
		...
		accountpar.accountId = $("#accountId:checked").val();
	     if(accountpar.accountId == null || accountpar.accountId == ""){
			...
			if(result){
				...
				$.ajax({
    	            url: 'rest/rbac/userController/delAccountInfo',
    	            async: false,
    	            //data: 'accountId='+accountpar.accountId,
    	            data:par,
    	            type: 'POST',
