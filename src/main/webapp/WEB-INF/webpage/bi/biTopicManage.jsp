	    				...
	    				if(result.data != "error"){
	    					...
	    					for(var i=0; i< result.data.length; i++){
	    						if(value == result.data[i]){
	    							$("#biz_Table_Name").append("<option selected='selected' value="+result.data[i]+">"+result.data[i]+"</option>");
	    						}else{
	    							$("#biz_Table_Name").append("<option value="+result.data[i]+">"+result.data[i]+"</option>");
	    						}
	    					}
	    				}else{
