...
<body style="background-color:#FFFFFF;  overflow-x : hidden ;" >
    <div class="row">
		<div class="col-md-12 col-xs-12 col-lg-12 widget-body" style="margin-right:0 ;">
	     ...
	     <!-- 查询条件结束 -->
			<!-- 菜单操作项datables开始 -->
			<div class="table-header">已办理工作</div>
			<div class="row">
				<div class="col-md-8" style="margin-left:6px;height:30px; margin-bottom:10px; margin-top:5px;">
					...
					<button class="btn btn-primary btn-sm" id="btnWorkFlowPrint">打印</button>
    ...
    <script type="text/javascript">
		...
		$( "#btnDelete" ).on('click', function(e) {
			parent.bootbox.alert("点击了"+this.id, function(){});
			delInfo();
		});
