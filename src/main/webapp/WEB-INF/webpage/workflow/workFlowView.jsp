    ...
    $(document).ready(function () {
        ...
        function getJsonData(flowID) {  
            ...
            $.ajax({
                ...
                async: false,
	            dataType: 'json',
                url: "rest/workflow/workPersonal/getWorkFlowCheckInfo", 
                data:params,
    ...
    function GetQueryString(name) {
     ...
     function GetActivityInfo(activityID, e) {
         ...
         $.ajax({
             ...
             dataType: "json",
             async: false,
             url: "rest/workflow/workPersonal/GetMonitorInfo",
             ...
             success: function (data){
                 ...
                 if(data.data.length > 0){
	                 for(var i=0; i<data.data.length; i++){
	                 	$(".title").append("<ul><li style='list-style-type:none; margin-left:-13px; color:#FFFFFF;'>监控者："+data.data[i]+"</li>");
	                 }
	             }else{
	             	$(".title").append("<ul><li style='list-style-type:none; margin-left:-13px; color:#FFFFFF;'>监控者：无</li>");
	             }
             }
         });
         return dataInfo;
