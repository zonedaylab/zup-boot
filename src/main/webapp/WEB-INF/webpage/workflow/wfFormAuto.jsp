...
<!--                    <li class="nav-header rowjj">表单控件</li>-->
                    ...
                    <li><a href="javascript:void(0);" onclick="formDesign.exec('divs');" class="btn btn-default btn-small col-md-1 col-lg-1 col-xs-5 jj">响应布局</a></li>
            ...
            <div class="span10">
                <script id="formEditor" type="text/plain" style="width:100%; margin-top:10px;">${ content}</script>
            </div>
        </div><!--end row-->
...
var formDesign = {
    ...
    fnCheckForm : function ( type ) {
        ...
        if(formEditor.hasContents()){
            ...
            $.ajax({
                type: 'POST',
                url : '${ctx}/rest/workflow/workFormAutoController/FormAutoEdit',
                //contentType: "application/json; charset=utf-8",
                dataType : 'json',
                data : {'type' : type_value,'formID':'${ param.formID}','parse_form':parse_form},
