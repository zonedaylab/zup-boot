 ...
 * @example
 * ```javascript
 * editor.execCommand( 'forms');
 * ```
 */
UE.plugins['forms'] = function () {
	var me = this,thePlugins = 'forms';
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/forms.html',
				name:thePlugins,
				editor:this,
				title: 'form表单',
				cssRules:"width:600px;height:380px;",
...
UE.plugins['upload'] = function () {
	...
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/upload.html',
				name:thePlugins,
				editor:this,
				title: '文件上传控件',
				cssRules:"width:600px;height:380px;",
 ...
 * @example
 * ```javascript
 * editor.execCommand( 'dates');
 * ```
 */
UE.plugins['dates'] = function () {
	var me = this,thePlugins = 'dates';
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.formDesignUrl+'/dates.html',
				name:thePlugins,
				editor:this,
				title: '时间控件',
				cssRules:"width:600px;height:380px;",
